    ...
    <section class="content wide">
      ...
      <div class="filters">
        ...
        <select id="filterSucursal">
          ...
          <?php foreach(array_unique(array_column($inventario,'sucursal')) as $suc): ?>
      ...
      <div class="table-wrapper centered">
        <table class="table full-width table-sortable" id="inventarioTable">
          <thead>
            <tr>
              <th>ID</th>
              <th>Producto</th>
              ...
              <?php foreach($inventario as $i): ?>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="inventario-eliminar.php?id=<?= $i['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Eliminar registro?')">🗑️</a>
                  </td>
                </tr>
              <?php endforeach; ?>
            <?php else: ?>
