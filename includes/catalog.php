  ...
  <div class="catalog-container">
    ...
    <div class="catalog-grid">
      <?php if (!empty($productos)): ?>
        ...
        ?>
          <div class="catalog-card product-card" data-product-id="<?= $producto_id ?>" data-id="<?= $producto_id ?>">
            ...
            <?php if ($precio > 0): ?>
              <button class="catalog-card-price js-cart" data-id="<?= $producto_id ?>" title="Agregar al carrito">
