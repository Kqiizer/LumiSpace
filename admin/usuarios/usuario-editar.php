...
<head>
  ...
  <style>
    body { font-family: 'Roboto', 'Segoe UI', system-ui, -apple-system, sans-serif; background: linear-gradient(135deg, #f4f1ec, #e9e4dd); color: #2a1f15; }
    ...
    input, select, textarea { padding: 10px 12px; border: 1px solid #ccc; border-radius: 8px; font-size: .95rem; transition: all .2s ease; background-color: #fff; font-family: 'Roboto', 'Segoe UI', system-ui, -apple-system, sans-serif; }
